...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='film',
            name='characters',
            field=models.ManyToManyField(related_name='films', to='starwars.People', blank=True),
        ),
        migrations.AddField(
            model_name='film',
            name='planets',
            field=models.ManyToManyField(related_name='films', to='starwars.Planet', blank=True),
        ),
        migrations.AddField(
            model_name='film',
            name='species',
            field=models.ManyToManyField(related_name='films', to='starwars.Species', blank=True),
        ),
        migrations.AddField(
            model_name='vehicle',
            name='pilots',
            field=models.ManyToManyField(related_name='vehicles', to='starwars.People', blank=True),
        ),
        migrations.AddField(
            model_name='starship',
            name='pilots',
            field=models.ManyToManyField(related_name='starships', to='starwars.People', blank=True),
        ),
        migrations.AddField(
            model_name='film',
            name='starships',
            field=models.ManyToManyField(related_name='films', to='starwars.Starship', blank=True),
        ),
        migrations.AddField(
            model_name='film',
            name='vehicles',
            field=models.ManyToManyField(related_name='films', to='starwars.Vehicle', blank=True),
        ),
    ]
